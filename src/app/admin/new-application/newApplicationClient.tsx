...
export default function NewApplicationClient(props: {
  ...
  return (
    <form onSubmit={newApplicationClient} className="flex flex-col gap-6 mt-7">
      <div className="flex flex-col gap-4">
        ...
        <div className="flex flex-col gap-2">
          <label className="text-sm lg:text-base font-medium">Stillinger</label>
          <input
      ...
      {status.error && (
        <p className="text-sm lg:text-base text-red-400 mt-4">{status.error}</p>
      )}
      <input
